...
<body onLoad="focusIt();" bgcolor="${bodyback_c}">
  <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
      <tr>
       ...
       <form name="inform" method="post" action="/realtest/member/loginPro.do"  onSubmit="return checkIt();">
      ...
      <tr > 
       ...
       <tr>
          <td colspan="3" bgcolor="${title_c}"   align="center">
            ...
            <input type="button"  value="회원가입" onclick="javascript:window.location='/realtest/member/inputForm.do'">
          </td></form></tr></table>
